...
# urlpatterns += static(settings.prod.MEDIA_URL, document_root = settings.prod.MEDIA_ROOT)
# urlpatterns += static(settings.STATIC_URL, document_root=settings.prod.STATIC_ROOT)